...
def mimggen8910(args):
    ...
    btnvsrc = os.path.join( os.path.dirname(cpprj), "ProductionParam_uix8910.nvm")
    btnvdst = os.path.join( os.path.dirname(apprj), "ProductionParam_uix8910.nvm")
    print("cp %s %s " % (btnvsrc, btnvdst))
    shutil.copy(btnvsrc, btnvdst)
